...
Use the current version's wheel URL from [Releases](https://github.com/ensomniac/codex-ui/releases/latest). The commands below use the current release:

```sh
# uv
uv tool install 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac_codex_ui-2.1.0-py3-none-any.whl'

# pipx
pipx install 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac_codex_ui-2.1.0-py3-none-any.whl'

# pip, in an environment you own
python3 -m venv ~/.local/share/codex-ui/venv
~/.local/share/codex-ui/venv/bin/python -m pip install 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac_codex_ui-2.1.0-py3-none-any.whl'
...
```sh
npm install -g 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac-codex-ui-2.1.0.tgz'
pnpm add -g 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac-codex-ui-2.1.0.tgz'
yarn global add 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac-codex-ui-2.1.0.tgz'
bun add -g 'https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac-codex-ui-2.1.0.tgz'
npx --yes --package='https://github.com/ensomniac/codex-ui/releases/download/v2.1.0/ensomniac-codex-ui-2.1.0.tgz' codex-ui --version
```
